...
def buscar_ofertas_filtradas():
    """
    Busca ofertas do CRM e filtra pelo cursoNome 'Apoio / Auxílio'
    """
    ...
    try:
        ...
        ofertas_filtradas = [
            ...
            if oferta.get('cursoNome') == 'Apoio / Auxílio'
        ]
        ...
        print(f"Total de ofertas filtradas (Apoio / Auxilio): {total_ofertas}")
        ...
        if resultado:
            ...
            nome_arquivo = f"ofertas_apoio_auxilio_{timestamp}.xlsx"
            ...
            print("\n[AVISO] Nenhuma oferta encontrada com o criterio 'Apoio / Auxilio'")
